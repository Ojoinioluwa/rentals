...
bookingRouter.post("/:id", authorize("renter"), bookController.createBooking);

// Get all bookings by the tenant
bookingRouter.get("/me", authorize("renter"), bookController.getMyBookings);

// Get a single booking by the renter
bookingRouter.get("/me/:id", authorize("renter"), bookController.getBooking);
