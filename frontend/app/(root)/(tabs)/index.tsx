          ...
          {isLandlord ? (
            ...
            >
              ...
              <ActionCard
                ...
                onPress={() => router.push("/MyPropertiesLandlord")}
                delay={0}
              />
              <ActionCard
                icon="📬"
              ...
              <ActionCard
                icon="⬆️"
                title="Upload Images"
                description="Add more images to your properties."
                onPress={() => console.log("Navigate to UploadImagesScreen")}
                delay={300}
              />
            </Animated.View>
          ) : (
            ...
            >
              ...
              <ActionCard
                ...
                onPress={() => console.log("Navigate to AllPropertiesScreen")}
                delay={0}
              />
              <ActionCard
                icon="📄"
