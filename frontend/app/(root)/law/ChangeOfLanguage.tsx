  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <ScrollView className="flex-1 p-5">
        ...
        {/* Section: Change of Language */}
        <Text className="text-xl font-bold text-gray-800 mb-3">
          7. Change of Language
        </Text>
        <Text className="text-gray-700 text-base mb-4 leading-6">
          This Privacy Policy is written in English. Any translated versions are
          provided for your convenience only. In case of any discrepancies or
          conflicts between the English version and a translated version, the
